  ...
  <section class="home">
    <!-- <header class="flex-coloumn">
      ...
      <div class="home-container flex-coloumn">
        <autocomplete class="home-search" :placeholder1="isScreenNarrow ? 'Add drug / herb' : 'Add drug / herb / supplement'" placeholder2="Add another" @item-selected="goToSearch" />
        <button class="btn home-cta" @click="searchWithBtn">Get interactions</button>
      ...
      <div class="home-container">
        ...
        <ul class="flex-space-between">
          <li class="flex-coloumn">
            <animated-integer :value="stats.totalClinicalCount" :duration="2.5" />
            Clinical trials
          </li>
          <li class="flex-coloumn">
            <animated-integer :value="stats.totalPreClinicalCount" :duration="2.5" />
            Pre-clinical trials
          </li>
          <li class="flex-coloumn">
            <animated-integer :value="stats.totalArticlesCount" :duration="2.5" />
            Other articles
          </li>
        </ul>
      </div>
      ...
      <!-- <ul class="home-content-list">
        ...
        <li class="home-content-list-item">
          <article class="main-container">
            ...
            <p><span class="font-bold">Provide</span> the best integrative treatment through access to vital information on both negative and synergistic Herb-Supplement-Drug interactions.</p>
          </article>
        ...
        <li class="home-content-list-item">
          <article class="main-container">
            <h1>Ensure safety</h1>
            <p><span class="font-bold">Provide</span> optimal protection from undesired interactions.</p>
          </article>
        </li>
        <li class="home-content-list-item">
          <article class="main-container">
            ...
            <p>
              ...
              insights on which clinical and laboratory parameters to monitor per individual patient profile or interaction.
            </p>
          </article>
        </li>
        <li class="home-content-list-item">
    ...
    <pass-change-success v-if="passwordModal" @closeModal="passwordModal = false" />
  </section>
</template>
  ...
  methods: {
    ...
    goToSearch(query) {
      ...
      if (this.searches.length >= 2) {
        const searchQuery = this.searches
          .map((q, idx) => {
