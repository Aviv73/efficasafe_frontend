    ...
    <section class="material-details no-print" :class="{'not-allowed-select-txt': isNotAllowedSelect}">
        <template v-if="!isLoading">
            ...
            <template v-if="material">
                <drug-details @openShareModal="openShareModal" :originalMaterial="material" v-if="material.type === 'drug'" />
                <herb-details @openShareModal="openShareModal" :originalMaterial="material" v-if="material.type === 'herb'" />
                <supp-details @openShareModal="openShareModal" :originalMaterial="material" v-if="material.type !== 'herb' && material.type !== 'drug'" />
            </template>
        </template>
