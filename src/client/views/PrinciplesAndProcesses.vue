    ...
    <section class="principles-and-processes">
        ...
        <article class="principles-and-processes-container">
            ...
            <section class="principles-and-processes-lists">
                <div>
                    <h4 class="font-bold">All Efficasafe data is:</h4>
                    <ul class="styled-ul">
                        <li>Evidence-based</li>
                        <li>Reviewed and approved</li>
                        <li>Clinically relevant</li>
                        <li>Monitored and regularly updated</li>
                    </ul>
                </div>
                <div>
                    <h4 class="font-bold">All Efficasafe data is <span>not</span>:</h4>
                    <ul class="styled-ul">
                        <li>Based on opinion or beliefs</li>
                        <li>Biased in any way</li>
                        <li>Connected to advertisers or sponsorships</li>
                    </ul>
                </div>
            </section>
            <h2>Practice</h2>
            <h3 class="page-header2">Evidence-Based Foundation</h3>
            <p>
                ...
                from one person to another, sometimes over generations. With natural medicines,
                this is especially true. As a result, the efficacy information of a variety
            ...
            <h3 class="page-header2">Reliable contributors</h3>
            <p>
                ...
                The contributor group includes writers, researchers, and editors.
            ...
            <p>
                ...
                enough for traditional use. Objectivity is paramount in a contributor's
                approach to natural medicines. This includes no bias or conflicts of
                interest in the objective evaluation of the data.
            ...
            <h3 class="page-header2">Clinically practical</h3>
            <p>
            ...
            <h3 class="page-header2">Continuous Search</h3>
            <p>
                ...
                if deemed relevant, added to the database based on previous findings.
            ...
            <h2>Literature</h2>
            <h3 class="page-header2">A systematic approach</h3>
            <p>
                ...
                databases using pin-point search criteria. This process is carried out for each new monograph.
                Searches are carried out using botanical names, synonyms, and/or scientific or chemical names.
                Databases are searched whenever appropriate.

                <span class="d-block inner-paragraph">
                    Research articles are selected only if they have the potential
                    to deliver relevant information regarding interactions with drugs
                    and/or alternating practice information and lab test interference.
                </span>
            </p>
            <h3 class="page-header2">Critical appraisal</h3>
            <div class="parent-paragraph">
                <p>
                    The critical evaluation of all initially identified literature
                    is based upon the following defined criteria:
                </p>
                <h4 class="d-block font-bold">Relevance</h4>
                <p>
                    The retention of literature that provides the most wealth
                    in data is used to further evaluate the data’s validity.
                    To be deemed relevant, the adequate addressing of an issue important
                    to health professionals must be included in the literature.
                    This, for the most part, includes information regarding product
                    safety and effectiveness. The information speaks about the action
                    mechanism or pharmacology as well as adverse interactions or lab test inference.
                    Any literature that does not address practical and relevant issues is excluded.
                </p>
                <h4 class="d-block font-bold">Validity</h4>
                <p>
                    All information deemed relevant,
                    provided by the literature is evaluated for validity.
                    With the end goal being the design’s adequacy for providing valid results,
                    each study is reviewed based upon the methodology and study conduct.
                    <span class="inner-paragraph">
                        Utilizing the scale below, the level of evidence as well as the study quality,
                        can be assessed / determined.
                    </span>
                    <table class="evidence-table">
                        <tbody>
                                <tr>
                                <td>A</td>
                                <td>multi clinical or meta</td>
                            </tr>
                            <tr>
                                <td>B</td>
                                <td>1 clinical or cohort + pre-clinical</td>
                            </tr>
                            <tr>
                                <td>C</td>
                                <td>1 clinical or cohort</td>
                            </tr>
                            <tr>
                                <td>D</td>
                                <td>case report</td>
                            ...
                            <tr>
                                <td>E</td>
                                <td>multi pre-clinical</td>
                            </tr>
                            <tr>
                                <td>F</td>
                                <td>1 pre clinical</td>
                            </tr>
                        </tbody>
                    </table>
                </p>
            </div>
            <h3 class="page-header2">Consistency</h3>
            <p>
            ...
            <h3 class="page-header2">Peer review</h3>
            <p>
                Through its peer review approach, Efficasafe addresses
                all multidisciplinary and multi-pronged database content.
                Multidisciplinary practitioners comprise the editorial review board.
                This includes those from the pharmaceutical, naturopathy, medicine,
                research, and nutrition industries, along with many others. 
                The peer review approach is used not only to ensure the reliability
            ...
            <h3 class="page-header2">Content prioritization</h3>
            <p>
            ...
            <h3 class="page-header2">Continuous updates, innovation, and improvement</h3>
            <p>
                The Efficasafe team is continuously improving the experience of the user.
            ...
            <p>
                ...
                and the sheer volume of that information is growing rapidly.
                By focusing on the information that is the most practical,
                Efficasafe assists users in getting the information that is most
                relevant while keeping efficiency as high as possible.
                With the continuation of enhancing both technological and editorial in nature,
