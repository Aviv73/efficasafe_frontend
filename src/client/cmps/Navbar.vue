      ...
      <div class="flex-space-between">
        ...
        <ul class="navbar-nav">
          <li class="navbar-nav-item">
            <button :class="{ highlight: !loggedInUser }">Subscribe</button>
          </li>
          <li class="navbar-nav-item">
            <button v-if="!loggedInUser" class="login-btn" @click="onLogin">
              Login
            </button>
            <button v-else class="logout-btn" @click="onLogout">Log Out</button>
          </li>
