    ...
    <section>
        ...
        <v-card class="material-edit" v-if="editedMaterial">
            <v-form v-model="valid" @submit.prevent="saveMaterial">
                ...
                <div class="list-chips">
                    <v-text-field
                        ...
                        @keypress.enter.prevent="
                            addItemToArray('medicinalActions')
                        "
                    />
                    <v-chip-group column>
                        <v-chip
                            v-for="(action,
                            idx) in editedMaterial.medicinalActions"
                            :key="idx"
                            close
                ...
                <div class="list-chips">
                    ...
                    <v-chip-group column>
                        <v-chip
                            v-for="(indication,
                            idx) in editedMaterial.indications"
                            :key="idx"
                            close
            ...
            <div class="form-actions">
                <v-btn class="cancel-btn" to="/material/" color="normal"
                    >cancel</v-btn
                >
                <v-btn
                    class="submit-btn"
    ...
    methods: {
        ...
        addLabelPaths(labelPaths) {
            const old = JSON.parse(
                JSON.stringify(this.editedMaterial.labelPaths)
            );
